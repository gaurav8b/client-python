...
if __name__ == "__main__":
    ...
    train_end_date = end_date - timedelta(days=1)     # Use yesterday as the end of training
    specific_day = end_date  # Predict for today
    ...
    logger.info(f"Prediction day: {specific_day}")

    if specific_day not in crypto_df.index:
        logger.error(f"No data available for the specified day: {specific_day}")
        sys.exit(1)
    ...
    logger.info(f"Predicting for: {specific_day}")
